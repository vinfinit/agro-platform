...
const ControlPanel = () => {
  ...
  return (
    <div className={styles.controlPanel}>
      ...
      <section className={curState === STATES.INTRODUCTION ? '' : styles.hidden}>
      ...
      <section className={curState === STATES.LEGEND ? '' : styles.hidden}>
        <h3>Легенда</h3>
        <ul>
      ...
      <section className={curState === STATES.ALGORITHMS ? '' : styles.hidden}>
